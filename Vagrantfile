...
#      ansible.playbook = "deploy_CRolesRH7.yml"
##     ansible.groups = {
...
# end
  config.vm.define "CRolesRH7" do |CRolesRH7|
    CRolesRH7.vm.box = "clouddood/RH7.5_baserepo"
    CRolesRH7.vm.hostname = "crolesRH7"
    CRolesRH7.vm.network "private_network", ip: "192.168.60.167"
#   CRolesRH7.vm.network "private_network", ip: "192.168.60.167", nic_type: "virtio"
    CRolesRH7.vm.provision "shell", :inline => "sudo echo '192.168.60.167 crolesRH7.local crolesRH7' >> /etc/hosts"

##  Use Main / Update in Vagrant provision command ### $vagrant provision --provision-with shell/main/update

    # Default
    CRolesRH7.vm.provision "main", type: "ansible" do |ansible|
#     ansible.playbook = "deploy_CRolesRH7.yml"
      ansible.playbook = "deploy_CRolesRH7_DEV.local.yml"
#     ansible.playbook = "deploy_chromeTestRH7.yml"
    ...
    # Update
#   CRolesRH7.vm.provision "update", type: "ansible" do |ansible|
